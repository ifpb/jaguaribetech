...
```text
Por fim, existe a possibilidade de testar um aplicativo hibrido diretamente em um ambiente nativo, ou seja,
diretamente em um dispositivo móvel. Em dispositivos Android, o procedimento é bastante simples. 
